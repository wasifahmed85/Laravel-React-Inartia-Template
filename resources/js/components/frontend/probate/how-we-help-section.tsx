    ...
    return (
        <section ref={ref} className="bg-slate-50 py-20 px-4">
            <div className="max-w-6xl mx-auto">
                <h2 className={`text-4xl font-bold text-center text-gray-900 mb-16 ${base} ${state}`} style={{ transitionDelay: '0ms' }}>
                ...
                <div className="grid md:grid-cols-4 gap-8 mb-12">
                    <div className={`text-center ${tileClass}`} style={{ transitionDelay: '100ms' }}>
                        ...
                        <h3 className="font-bold text-lg text-gray-900 mb-2">Streamlined process</h3>
                    ...
                    <div className={`text-center ${tileClass}`} style={{ transitionDelay: '200ms' }}>
                        ...
                        <h3 className="font-bold text-lg text-gray-900 mb-2">Prices are transparent and fixed upfront</h3>
                        <p className="text-sm text-gray-600">We&apos;ll never charge you hidden costs so you won&apos;t worry about
                    ...
                    <div className={`text-center ${tileClass}`} style={{ transitionDelay: '300ms' }}>
                        ...
                        <h3 className="font-bold text-lg text-gray-900 mb-2">You&apos;ll get dedicated support</h3>
                        <p className="text-sm text-gray-600">Our award-winning team are on your side as you know what&apos;s
                            happening at every step</p>
                    </div>
                    ...
                    <div className="text-center">
                        ...
                        <h3 className="font-bold text-lg text-gray-900 mb-2">No fees for face to face appointments</h3>
                        <p className="text-sm text-gray-600">Legal firms often can be more than five times the upfront cost
                            of our service</p>
                    </div>
                </div>
